...
export default function PendingDegreeFee() {
  ...
  const handleApprove = (paymentID: string) => {
    ...
    setDegreeFee((prev) => prev.filter((f) => f.paymentID !== paymentID));
  };
                ...
                >
                  ...
                  <td>
                    <div className="flex justify-center gap-2">
                      <button
                        onClick={() => handleApprove(fee.paymentID)}
                      ...
                      <button
                        onClick={() => handleReject(fee.paymentID)}
